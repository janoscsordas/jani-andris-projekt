    ...
    return (
        <div className="w-full min-h-screen flex flex-col justify-center items-center bg-background">
            ...
            <form action="" onSubmit={handleLogin}>
                <Input className="w-[20rem] mb-2" type="email" placeholder="Email cím" required={true} value={email} onChange={(e) => setEmail(e.target.value)} />
                <div className="relative">
                    <Input type={passwordIsSeen ? "text" : "password"} placeholder="Jelszó" required={true} maxLength={24} value={password} onChange={(e) => setPassword(e.target.value)} />
